...
/*
namespace wls { namespace plugin_tests {
...
WLS_DEFINE_PLUGIN( test, wls::plugin_tests::test_plugin )

FC_REFLECT( wls::plugin_tests::test_a_operation, (account) )
FC_REFLECT( wls::plugin_tests::test_b_operation, (account) )

DECLARE_OPERATION_TYPE( wls::plugin_tests::test_op );
FC_REFLECT_TYPENAME( wls::plugin_tests::test_op );
DEFINE_OPERATION_TYPE( wls::plugin_tests::test_op );
*/
